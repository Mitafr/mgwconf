...
use crate::model::prelude::InnerEntityTrait;
use crate::ui::prelude::*;

pub const CONFIGURATION_USER_TAB: [&str; 5] = ["Certificates", "SAGs", "Business Application", "Profiles", "Api Proxy"];

pub fn draw_configuration_user_block<A, B>(f: &mut Frame<B>, app: &A, layout_chunk: Rect)
where
    A: UiAppTrait,
    B: Backend,
{
...
pub fn draw_configuration<A, B>(f: &mut Frame<B>, app: &A, layout_chunk: Rect)
where
    A: UiAppTrait,
    B: Backend,
{
...
pub fn draw_configuration_sags<A, B>(f: &mut Frame<B>, app: &A, layout_chunk: Rect)
where
    A: UiAppTrait,
    B: Backend,
{
...
pub fn draw_configuration_certificates<A, B>(f: &mut Frame<B>, app: &A, layout_chunk: Rect)
where
    A: UiAppTrait,
    B: Backend,
{
...
pub fn draw_configuration_business_applications<A, B>(f: &mut Frame<B>, app: &A, layout_chunk: Rect)
where
    A: UiAppTrait,
    B: Backend,
{
...
pub fn draw_detailed_entity<A, B>(f: &mut Frame<B>, app: &A, layout_chunk: Rect)
where
    A: UiAppTrait,
    B: Backend,
{
