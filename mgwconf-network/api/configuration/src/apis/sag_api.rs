...
pub async fn sag_create(
    ...
    sag_entity: models::SagEntity,
) -> Result<ResponseContent<SagCreateSuccess>, Error<SagCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<SagCreateSuccess> =
...
pub async fn sag_delete(
    ...
    hostname: &str,
    port: i32,
) -> Result<ResponseContent<SagDeleteSuccess>, Error<SagDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<SagDeleteSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sag_get(
    ...
    hostname: Option<&str>,
    port: Option<i32>,
) -> Result<ResponseContent<SagGetSuccess>, Error<SagGetError>> {
    let local_var_configuration = configuration;
...
pub async fn sag_update(
    ...
    port: i32,
    sag_entity: models::SagEntity,
) -> Result<ResponseContent<SagUpdateSuccess>, Error<SagUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<SagUpdateSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
