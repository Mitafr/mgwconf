...
pub async fn certificate_create(
    ...
    certificate_entity: models::CertificateEntity,
) -> Result<ResponseContent<CertificateCreateSuccess>, Error<CertificateCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CertificateCreateSuccess> =
...
pub async fn certificate_delete(
    configuration: &configuration::Configuration,
    alias: &str,
) -> Result<ResponseContent<CertificateDeleteSuccess>, Error<CertificateDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CertificateDeleteSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn certificate_get(
    configuration: &configuration::Configuration,
    alias: Option<&str>,
) -> Result<ResponseContent<CertificateGetSuccess>, Error<CertificateGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CertificateGetSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn certificate_update(
    ...
    alias: &str,
    certificate_entity: models::CertificateEntity,
) -> Result<ResponseContent<CertificateUpdateSuccess>, Error<CertificateUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CertificateUpdateSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
