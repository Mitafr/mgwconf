...
pub async fn forward_proxies_info_get(
    ...
    hostname: Option<&str>,
    port: Option<&str>,
) -> Result<ResponseContent<ForwardProxiesInfoGetSuccess>, Error<ForwardProxiesInfoGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxiesInfoGetSuccess> =
...
pub async fn forward_proxy_info_create(
    configuration: &configuration::Configuration,
    forward_proxy_entity: models::ForwardProxyEntity,
) -> Result<ResponseContent<ForwardProxyInfoCreateSuccess>, Error<ForwardProxyInfoCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxyInfoCreateSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn forward_proxy_info_delete(
    ...
    hostname: &str,
    port: &str,
) -> Result<ResponseContent<ForwardProxyInfoDeleteSuccess>, Error<ForwardProxyInfoDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxyInfoDeleteSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn forward_proxy_info_update(
    ...
    port: &str,
    forward_proxy_entity: models::ForwardProxyEntity,
) -> Result<ResponseContent<ForwardProxyInfoUpdateSuccess>, Error<ForwardProxyInfoUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxyInfoUpdateSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
