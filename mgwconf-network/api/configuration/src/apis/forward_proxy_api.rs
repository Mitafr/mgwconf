...
/// struct for typed successes of method [`forward_proxies_info_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ForwardProxiesInfoGetSuccess {
    Status200(String),
    Status204(),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`forward_proxy_info_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ForwardProxyInfoCreateSuccess {
    Status201(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`forward_proxy_info_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ForwardProxyInfoDeleteSuccess {
    Status200(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`forward_proxy_info_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ForwardProxyInfoUpdateSuccess {
    Status200(serde_json::Value),
    UnknownValue(serde_json::Value),
}
...
pub async fn forward_proxies_info_get(configuration: &configuration::Configuration, hostname: Option<&str>, port: Option<&str>) -> Result<ResponseContent<ForwardProxiesInfoGetSuccess>, Error<ForwardProxiesInfoGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxiesInfoGetSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn forward_proxy_info_create(configuration: &configuration::Configuration, forward_proxy_entity: models::ForwardProxyEntity) -> Result<ResponseContent<ForwardProxyInfoCreateSuccess>, Error<ForwardProxyInfoCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxyInfoCreateSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn forward_proxy_info_delete(configuration: &configuration::Configuration, hostname: &str, port: &str) -> Result<ResponseContent<ForwardProxyInfoDeleteSuccess>, Error<ForwardProxyInfoDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxyInfoDeleteSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn forward_proxy_info_update(configuration: &configuration::Configuration, hostname: &str, port: &str, forward_proxy_entity: models::ForwardProxyEntity) -> Result<ResponseContent<ForwardProxyInfoUpdateSuccess>, Error<ForwardProxyInfoUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ForwardProxyInfoUpdateSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
