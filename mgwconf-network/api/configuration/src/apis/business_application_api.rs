...
pub async fn business_application_create(configuration: &configuration::Configuration, business_application_entity: models::BusinessApplicationEntity) -> Result<ResponseContent<BusinessApplicationCreateSuccess>, Error<BusinessApplicationCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<BusinessApplicationCreateSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn business_application_delete(configuration: &configuration::Configuration, application_name: &str) -> Result<ResponseContent<BusinessApplicationDeleteSuccess>, Error<BusinessApplicationDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<BusinessApplicationDeleteSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn business_application_get(configuration: &configuration::Configuration, application_name: Option<&str>) -> Result<ResponseContent<BusinessApplicationGetSuccess>, Error<BusinessApplicationGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<BusinessApplicationGetSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<BusinessApplicationGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn business_application_update(configuration: &configuration::Configuration, application_name: &str, business_application_entity: models::BusinessApplicationEntity) -> Result<ResponseContent<BusinessApplicationUpdateSuccess>, Error<BusinessApplicationUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<BusinessApplicationUpdateSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<BusinessApplicationUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
