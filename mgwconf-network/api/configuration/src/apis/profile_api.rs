...
pub async fn application_profile_create(
    ...
    application_profile_entity: models::ApplicationProfileEntity,
) -> Result<ResponseContent<ApplicationProfileCreateSuccess>, Error<ApplicationProfileCreateError>>
{
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ApplicationProfileCreateSuccess> =
...
pub async fn application_profile_delete(
    ...
    profile_name: &str,
) -> Result<ResponseContent<ApplicationProfileDeleteSuccess>, Error<ApplicationProfileDeleteError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ApplicationProfileDeleteSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn application_profile_get(
...
) -> Result<ResponseContent<ApplicationProfileGetSuccess>, Error<ApplicationProfileGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ApplicationProfileGetSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn application_profile_update(
    ...
    profile_name: &str,
    application_profile_entity: models::ApplicationProfileEntity,
) -> Result<ResponseContent<ApplicationProfileUpdateSuccess>, Error<ApplicationProfileUpdateError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ApplicationProfileUpdateSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
