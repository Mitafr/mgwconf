...
use crate::model::monitoring::ErrorDefaultResponse;
...
/// This API is to get information about  connectivity to other required services
pub async fn health_check(
    configuration: &configuration::Configuration,
) -> Result<String, Error<HealthCheckError>> {
