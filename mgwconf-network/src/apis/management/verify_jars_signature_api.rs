...
pub async fn verify_jars(configuration: &configuration::Configuration, path: Option<&str>) -> Result<Vec<crate::models::management::JarVerificationEntity>, Error<VerifyJarsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VerifyJarsError> = serde_json::from_str(&local_var_content).ok();
