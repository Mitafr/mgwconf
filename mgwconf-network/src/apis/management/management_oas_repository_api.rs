...
use crate::{apis::management::ResponseContent, models::management::OasRepository};

/// struct for typed errors of method [`oas_repository_pull`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OasRepositoryPullError {
...
pub async fn oas_repository_pull(configuration: &configuration::Configuration, source: Option<OasRepository>) -> Result<crate::models::management::UpdatedOasInfo, Error<OasRepositoryPullError>> {
