...
pub enum SagActiveGetError {
    ...
    DefaultResponse(crate::models::management::ErrorCode),
...
pub async fn sag_active_get(configuration: &configuration::Configuration) -> Result<crate::models::management::SagEntity, Error<SagActiveGetError>> {
...
pub async fn sag_active_update(configuration: &configuration::Configuration, sag_entity: crate::models::management::SagEntity) -> Result<serde_json::Value, Error<SagActiveUpdateError>> {
    let local_var_configuration = configuration;
