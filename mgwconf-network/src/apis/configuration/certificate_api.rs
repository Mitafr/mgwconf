...
pub async fn certificate_create(configuration: &configuration::Configuration, certificate_entity: crate::models::configuration::CertificateEntity) -> Result<serde_json::Value, Error<CertificateCreateError>> {
...
pub async fn certificate_update(
    ...
    alias: &str,
    certificate_entity: crate::models::configuration::CertificateEntity,
