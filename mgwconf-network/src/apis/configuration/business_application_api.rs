...
pub async fn business_application_create(
    ...
    business_application_entity: crate::models::configuration::BusinessApplicationEntity,
...
pub async fn business_application_get(configuration: &configuration::Configuration, application_name: Option<&str>) -> Result<serde_json::Value, Error<BusinessApplicationGetError>> {
    let local_var_configuration = configuration;
