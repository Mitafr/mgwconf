...
use crate::{apis::configuration::ResponseContent, models::configuration::Environment};
...
pub async fn api_gateway_info_create(configuration: &configuration::Configuration, api_gateway_info_entity: crate::models::configuration::ApiGatewayInfoEntity) -> Result<(), Error<ApiGatewayInfoCreateError>> {
...
pub async fn api_gateway_info_update(
    ...
    api_gateway_info_entity: crate::models::configuration::ApiGatewayInfoEntity,
